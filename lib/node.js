 ...
 * @param {Object} config
 * @param {String} config.network - Possible options "testnet/bcc", "regtest/bcc" or "livenet/bcc"
 */
Node.prototype._setNetwork = function(config) {
  if (config.network === 'testnet/bcc') {
    this.network = Networks.get('testnet/bcc');
  } else if (config.network === 'regtest/bcc') {
    Networks.enableRegtest();
    this.network = Networks.get('regtest/bcc');
  } else {
