...
function checkService(service) {
  ...
  if (!service.module.prototype ||
    ...
    throw new Error(
      'Could not load service ' + service.name + (serviceInfo.moduleName != serviceInfo.name ? ' using module name ' + serviceInfo.moduleName : '') + ' as it does not support necessary methods and properties.'
    );
  }
}
