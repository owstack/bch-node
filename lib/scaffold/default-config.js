...
/**
 * Will return the path and default bcccore-node configuration. It will search for the
 * configuration file in the "~/.bcccore" directory, and if it doesn't exist, it will create one
...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.bcccore');
  var defaultConfigFile = path.resolve(defaultPath, './bcccore-node.json');
