...
/**
 * Will return the path and default bch-node configuration. It will search for the
 * configuration file in the "~/.bch" directory, and if it doesn't exist, it will create one
...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.bch');
  var defaultConfigFile = path.resolve(defaultPath, './bch-node.json');
