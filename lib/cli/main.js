...
function main(servicesPath, additionalServices) {
  ...
  var create = bchnode.scaffold.create;
  var add = bchnode.scaffold.add;
  var start = bchnode.scaffold.start;
  var remove = bchnode.scaffold.remove;
  var callMethod = bchnode.scaffold.callMethod;
  ...
  program
    ...
    .option('-m, --modules <dir>', 'Specify the directory with Bch Node modules')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `bch-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ bch-node add wallet-service');
      console.log('    $ bch-node add explorer-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ bch-node remove wallet-service');
      console.log('    $ bch-node remove explorer-api');
      console.log();
    });
